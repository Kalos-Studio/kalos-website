...
|---|---|---|
| `body` background (L86) | `#000` | `#040406` Obsidian Black |
| `body` color (L87) | `#fff` | `#F5FEFD` Snow White |
| `p` color (L124) | `#888` | `#A8A8A8`, or white @ 32% |
| `h1` weight (L114) | `700` | 500 is the heaviest weight in the file |
| `h1` tracking (L115) | `-0.04em` | −0.02em |
| `p` (L122) | `letter-spacing: 0.2em`, uppercase | nothing in the file tracks positive |
...
Related: `app/layout.js:68` sets `themeColor: "#000000"` while
`app/(landing)/layout.js:37` sets `#040406`. The browser chrome and the page
ground are two different blacks depending on the route.

**Third black:** `app/(landing)/stage.js:8` exports `BACKDROP = "#060505"`. So
...
## 10. Open question for the brand owner 🟡
...
8. Dark Silver vs. white@32%, and body copy colour (finding 10).
